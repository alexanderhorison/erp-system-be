...
module.exports = (sequelize, DataTypes) => {
  class Delivery_Order_Receipt_Outstanding_Product extends Model {
    ...
    static associate(models) {
      ...
      Delivery_Order_Receipt_Outstanding_Product.belongsTo(models.Delivery_Order_Receipt_Outstanding, {
        foreignKey: "deliveryOrderReceiptOutstandingId",
      });
      Delivery_Order_Receipt_Outstanding_Product.belongsTo(models.Delivery_Order_Product, {
